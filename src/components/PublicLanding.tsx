import { Building2, CheckCircle2, Clock3, Image as ImageIcon, MessageCircle, Ruler, Sparkles, Truck } from 'lucide-react';
      ...
      <main id="inicio">
        ...
        <section id="modelos" className="mx-auto max-w-7xl px-4 py-16">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            ...
            ].map(([title, measure, usage]) => (
              <Card key={title} className="flex h-full flex-col gap-3">
                <div className="rounded-xl bg-blue-50 p-3 text-brand-blue"><Truck /></div>
